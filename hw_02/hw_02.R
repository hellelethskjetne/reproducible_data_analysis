...
#### c(1, 2, "a")
a2 <- c(1, 2, "a")
class(a2) #"character" class, e.g., consists of a list of numeric and charater vectors, so are interpreted as a character vectors (numeric info cannot be inferred by characters)
