...
```{r questionone, include=T, message = FALSE, warning = FALSE}
...
```{r questiontwo, include=T, message = FALSE, warning = FALSE}
...
```{r questionthree, include=T, message = FALSE, warning = FALSE}
...
```{r questionfour, include=T, message = FALSE, warning = FALSE}
...
```{r questionfive, include=T, message = FALSE, warning = FALSE}
...
```{r questionsix, include=T, message = FALSE, warning = FALSE}
